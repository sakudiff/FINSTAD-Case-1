...
\textbf{Objective:} To assess asset performance during periods of high
versus low market fear. \textbf{Purpose of Code:} Segregates trading
days based on VIX levels and calculates conditional mean daily returns.
\textbf{Expected Output:} A grouped bar chart comparing returns under
different VIX regimes.
