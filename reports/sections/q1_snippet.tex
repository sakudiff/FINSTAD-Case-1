...
\textbf{Objective:} To determine which asset delivered the highest
return per unit of risk over the sample period. \textbf{Purpose of
Code:} Calculates the ratio of mean daily return to standard deviation
for each asset and visualizes the results. \textbf{Expected Output:} A
risk-adjusted return ratio for each asset, presented as a bar chart.
