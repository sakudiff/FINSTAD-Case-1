...
\textbf{Objective:} To evaluate the cross-asset correlation of daily
returns. \textbf{Purpose of Code:} Calculates and visualizes the
pairwise Pearson correlation coefficients across the selected assets.
\textbf{Expected Output:} A correlation heatmap matrix.
