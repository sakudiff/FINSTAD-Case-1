...
\textbf{Objective:} To rank assets by their total price return from 2020
to 2025. \textbf{Purpose of Code:} Calculates the total and annualized
returns for each asset across the entire sample period. \textbf{Expected
Output:} A bar chart ranking the assets by total percentage return.
