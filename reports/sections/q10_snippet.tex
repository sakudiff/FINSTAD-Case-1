...
\textbf{Objective:} To evaluate which assets served as effective
inflation hedges from 2021 to 2023. \textbf{Purpose of Code:} Computes
total cumulative returns during the high-inflation window where CPI YoY
exceeded 5\%. \textbf{Expected Output:} A horizontal bar chart of
cumulative returns during the inflationary period.
...
\subsection{Sec 7: Descriptive Statistics -- GALEDO, Enrique Lorenzo
Hermoso}\label{sec-7-descriptive-statistics-galedo-enrique-lorenzo-hermoso}

\emph{Mean, median, variance, std dev, min, max, range, skewness,
kurtosis.}
...
\subsection{Sec 8: Data Visualization -- SEBALLOS, Josiah Dweyn
Panganiban}\label{sec-8-data-visualization-seballos-josiah-dweyn-panganiban}

\emph{At least 8 professional-quality figures.}
...
\subsection{Sec 9: Exploratory Analysis -- SEECHUNG, Camille
Castro}\label{sec-9-exploratory-analysis-seechung-camille-castro}

\emph{Compare returns, volatility, inflationary periods, high-VIX
periods, interest-rate environments.}
...
\subsection{Sec 10: Investment Recommendation -- SEECHUNG, Camille
Castro}\label{sec-10-investment-recommendation-seechung-camille-castro}

\emph{Allocate USD 1,000,000.}
...
\subsection{Sec 11: Executive Dashboard -- CRUZ, Ricardo Miguel
Iñigo}\label{sec-11-executive-dashboard-cruz-ricardo-miguel-iuxf1igo}
