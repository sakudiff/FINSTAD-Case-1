...
\textbf{Objective:} To measure asset sensitivity to changes in the
10-year Treasury yield. \textbf{Purpose of Code:} Calculates mean
returns conditional on daily increases or decreases in the DGS10 rate.
\textbf{Expected Output:} A grouped bar chart showing returns
conditioned on yield direction.
