...
\textbf{Objective:} To measure crisis resilience during the COVID-19
market crash. \textbf{Purpose of Code:} Computes the cumulative return
of each asset over the February to March 2020 period. \textbf{Expected
Output:} A line chart showing the trajectory of each asset's drawdown
and recovery.
