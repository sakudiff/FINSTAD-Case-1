...
Loads all 8 CSV datasets from the data/ directory into R data frames. Records the original observation count for each dataset before any cleaning operations.
Datasets include 4 asset price series (AAPL, BDO, BTC, SPY) and 4 FRED macroeconomic series (CPI, DGS10, FEDFUNDS, VIX).
...
safe_kable(clean_summary, caption="Observations After Filtering, Missing Values, and Duplicates")
```
