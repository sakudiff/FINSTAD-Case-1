...
### Appendix A1: SQL Question 1
*Pertains to Section 6: SQL-Based Financial Investigation*

**Objective:** To determine which asset delivered the highest return per unit of risk over the sample period.
**Purpose of Code:** Calculates the ratio of mean daily return to standard deviation for each asset and visualizes the results.
**Expected Output:** A risk-adjusted return ratio for each asset, presented as a bar chart.
...
### Appendix A2: SQL Question 2
*Pertains to Section 6: SQL-Based Financial Investigation*

**Objective:** To measure crisis resilience during the COVID-19 market crash.
**Purpose of Code:** Computes the cumulative return of each asset over the February to March 2020 period.
**Expected Output:** A line chart showing the trajectory of each asset's drawdown and recovery.
...
### Appendix A3: SQL Question 3
*Pertains to Section 6: SQL-Based Financial Investigation*

**Objective:** To evaluate the cross-asset correlation of daily returns.
**Purpose of Code:** Calculates and visualizes the pairwise Pearson correlation coefficients across the selected assets.
**Expected Output:** A correlation heatmap matrix.
...
### Appendix A4: SQL Question 4
*Pertains to Section 6: SQL-Based Financial Investigation*

**Objective:** To rank assets by their total price return from 2020 to 2025.
**Purpose of Code:** Calculates the total and annualized returns for each asset across the entire sample period.
**Expected Output:** A bar chart ranking the assets by total percentage return.
...
### Appendix A5: SQL Question 5
*Pertains to Section 6: SQL-Based Financial Investigation*

**Objective:** To identify the extreme single-day gains and losses for each asset.
**Purpose of Code:** Extracts the maximum and minimum daily returns for each instrument to assess tail risk.
**Expected Output:** A grouped bar chart displaying the best and worst trading days.
...
### Appendix A6: SQL Question 6
*Pertains to Section 6: SQL-Based Financial Investigation*

**Objective:** To analyze momentum regime shifts using moving averages.
**Purpose of Code:** Implements a 20-day and 60-day simple moving average crossover strategy.
**Expected Output:** A multi-panel line chart showing crossover events and momentum trends.
...
### Appendix A7: SQL Question 7
*Pertains to Section 6: SQL-Based Financial Investigation*

**Objective:** To test whether elevated trading volume systematically coincides with higher volatility.
**Purpose of Code:** Partitions trading days into high-volume and normal-volume regimes and compares their mean absolute returns.
**Expected Output:** A grouped bar chart comparing volatility across volume regimes.
...
### Appendix A8: SQL Question 8
*Pertains to Section 6: SQL-Based Financial Investigation*

**Objective:** To assess asset performance during periods of high versus low market fear.
**Purpose of Code:** Segregates trading days based on VIX levels and calculates conditional mean daily returns.
**Expected Output:** A grouped bar chart comparing returns under different VIX regimes.
...
### Appendix A9: SQL Question 9
*Pertains to Section 6: SQL-Based Financial Investigation*

**Objective:** To measure asset sensitivity to changes in the 10-year Treasury yield.
**Purpose of Code:** Calculates mean returns conditional on daily increases or decreases in the DGS10 rate.
**Expected Output:** A grouped bar chart showing returns conditioned on yield direction.
...
### Appendix A10: SQL Question 10
*Pertains to Section 6: SQL-Based Financial Investigation*

**Objective:** To evaluate which assets served as effective inflation hedges from 2021 to 2023.
**Purpose of Code:** Computes total cumulative returns during the high-inflation window where CPI YoY exceeded 5%.
**Expected Output:** A horizontal bar chart of cumulative returns during the inflationary period.
